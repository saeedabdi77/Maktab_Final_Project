...
from .models import StoreType, Store, Product, Cart, CartItem, Order, Address
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            if 'addresses' in request.data:
                ...
                Order.objects.create(cart=cart, status='paid', address=address)
            return Response(data={'message': 'payment successful!'}, status=status.HTTP_204_NO_CONTENT)
